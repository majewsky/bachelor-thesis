...
% TODO: Framenummerierung, damit man sich bei Fragen darauf rückbeziehen kann
% TODO: nochmal überlegen, ob jede Definition trotz Verkürzung noch sachlich richtig ist
% TODO: Baum-Welch-Beispiel vllt lieber e(v|q) statt t(q|#)?
% NOTE: nicht vergessen, zu sagen, dass K und H(x) unambiguous sind
% TODO: zwischen den beiden Folien Instanziierung HMM eine weitere Folie mit X=..., Y=..., A=..., B=..., etc. außer H/K
% TODO: vllt verschiedene Bäume für dasselbe x darstellen, um die Korrespondenz zu Zustandsfolgen zu zeigen; daran Analogie von Counts zwischen BW-Alg und IO-EM-Alg erklären
%       z.B. mehrere Bäume, die (noun,(verb,T)) an verschiedenen Stellen enthalten bei demselben x und dann zeigen, dass diese zu count(noun,(verb,T)) beitragen
...
\begin{frame}\frametitle{Bsp. Syntaxbaum eines CFG aus Baumgrammatik}
