...
\cite[p.~15]{bucstuvog15}

{\color{red} TODO IO step mapping}

The three types of language models (model $p$, counting information $\varkappa$ and IO information $\mu$) thus form a hierarchy:

{\color{red} TODO replicate that hierarchy picture from bucstuvog15}
