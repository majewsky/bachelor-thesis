...
\begin{table}[p!]
 ...
 \begin{tabular}{|c|c||c|c|}%
  ...
  \\\hline\mystrut
  $(T,\#,x)$ & yes (initial) & $P_\uh(x)$ & $1$
  \\\hline\mystrut
  \mute$(T,\#,x_i\cdots x_n)$ & \mute no & \mute0 & \mute0
  \\\hline\mystrut
  $(T,q,\eps)$ & for $x\neq\eps$ & $t(\#|q)$ & $T_x(n,q)$
  \\\hline\mystrut
  \mute$(T,q,x)$ & \mute no & \mute0 & \mute0
  \\\hline\mystrut
 ...
 \caption{
  ...
  Overview of all inside weights and outside weights for the IO information $\mu_\uh$ as introduced in this chapter, for any fixed $\omega = (t,e)\in \Omega$. Unreachable grammar states are shown grayed out.
  \\[1ex]
