...
After having considered the case that $x=\eps$, it remains to calculate the
...
When we put these expressions into the definition of $c\!\dangle{\omega,\mu}$,
...
\begin{lemma}
 For any $p\in\um_C(A|B)$, there exists $\omega=(t,e)\isin\Omega$ such that $q_\omega = p$.
\end{lemma}
