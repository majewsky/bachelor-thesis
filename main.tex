...
\delimdef\lang#1{\dleft[\!\dleft[#1\dright]\!\dright]}
\delimdef\stepmap#1{\dleft(\!\dleft[#1\dright]\!\dright)}
...
\listofalgorithms
\bibliographystyle{alpha} % TODO: style is broken; e.g. "EM Algorithm" gets lowercased to "em algorithm" in title display
